...
const API_URL = 'http://arcaweb.test/api/V1/images/productos';

const get_imagenes_produc = async (id) => {
  try {
    ...
    if (response.data && response.data.data) {
      ...
      console.warn(`No se encontraron imágenes para el producto con ID: ${id}`);
...
export default get_imagenes_produc;
